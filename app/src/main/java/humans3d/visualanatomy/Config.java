...
public class Config {
    ...
    public static final String PURCHASECODE = "86781236-23d0-4b3c-7dfa-c1c147e0dece";
    // 4. Enjoy your app! :)
    ...
    public static final String HOST = "https://kalyanishrestha.com.np/?hideFooter=true";

    // Your URL including https:// or http:// prefix and including www. or any required subdomain (e.g., "https://www.example.org")
    public static String HOME_URL = "https://kalyanishrestha.com.np/?hideFooter=true";
    ...
    public static final int SPECIAL_LINK_HANDLING_OPTIONS = 2;

    // Add URL prefixes that you ALWAYS want to open in an in-app tab (e.g., {"https://www.google.com", "https://www.example.com/page"})
    public static String[] ALWAYS_OPEN_IN_INAPP_TAB = new String[]{"https://kalyanishrestha.com.np/?hideFooter=true"};
    ...
    public static final double SCALE_SPLASH_IMAGE = 75;
    ...
    public static String OFFLINE_SCREEN_BACKGROUND_COLOR = "#000000";

    //Set to "true" to prevent users from taking screenshots or screen recordings in the app
    public static boolean PREVENT_SCREEN_CAPTURE = true;
    ...
    public static final String FACEBOOK_URL = "https://www.saraswatishrestha.com.np";
    ...
    public static String HOME_URL_LOGOUT = "https://www.saraswatishrestha.com.np";
