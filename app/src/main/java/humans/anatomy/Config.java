...
public class Config {
    ...
    public static String HOME_URL = "https://www.saraswatishrestha.com.np";
    ...
    public static String[] ALWAYS_OPEN_IN_INAPP_TAB = new String[]{"https://www.saraswatishrestha.com.np"};
